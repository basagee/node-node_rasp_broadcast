...
PushClient.prototype.onReadData = function(recvBuffer) {
    ...
    try {
        ...
        case '2' : {     // push message
            ...
            var payload = recvBuffer.toString('utf8', offset);
            ...
            if (resCode === '0000') {
                ...
                if (payloadJson.SERVICE_TYPE === '00' || payloadJson.SERVICE_TYPE === '01' /*|| payloadJson.SERVICE_TYPE === '02'*/) {
                    console.log('broadcast push message. send to media application...');
                    console.log(payloadJson.MESSAGE)
                    jsutils.showModalWindow(payloadJson.MESSAGE + '&UUID=' + config.getDeviceId() + '&APPID=' + config.getApplicationPackageName())
